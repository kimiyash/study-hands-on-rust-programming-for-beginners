use iced::{
    ...
    Element, Font, HorizontalAlignment, Length, Row, Settings,
    Subscription, Text
};
...
impl Application for GUI {
    ...
    fn subscription(&self) -> Subscription<Self::Message> {
        let timer = Timer::new(Duration::from_micros(MILLSEC / FPS));
    ...
    fn view(&mut self) -> Element<Self::Message> {
        ...
        // init widgets
        let tick_text = Text::new(duration_text)
            .font(FONT).size(60);
